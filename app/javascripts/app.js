...
window.App = {
    ...
    depositToken: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            App.setStatus("Initiating Deposit... " + nameToken + " " + amountToken + " TOKENS from " + account);
            return exchangeInstance.depositToken(nameToken, amountToken, {from: account});
        }).then(function (txResult) {
            document.getElementById("inputAmountDepositToken").value = "";
            document.getElementById("inputNameDepositToken").value = "";
            App.refreshBalanceExchange();
            App.setStatus("Deposit complete.");
    ...
    withdrawToken: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            App.setStatus("Initiating Withdrawal... " + nameToken + " " + amountTokens + " TOKENS from " + account);
...
//listen to trading events
    ...
    sellToken: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            exchangeInstance = instance;
            return exchangeInstance.sellToken(tokenName, price, amount, {from: account, gas: 1000000});
        }).then(function(txResult) {
            document.getElementById("inputNameSellToken").value = "";
            document.getElementById("inputAmountSellToken").value = "";
            document.getElementById("inputPriceSellToken").value = "";
            App.refreshBalanceExchange();
            App.updateOrderBooks();
        }).catch(function(e) {
            console.log(e);
    ...
    buyToken: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            exchangeInstance = instance;
            return exchangeInstance.buyToken(tokenName, price, amount, {from: account});
        }).then(function(txResult) {
            App.refreshBalanceExchange();
            App.updateOrderBooks();
        }).catch(function(e) {
